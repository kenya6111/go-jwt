...
import (
	...
	"github.com/kenya6111/go-jwt/pkg/domain/model"
	"github.com/kenya6111/go-jwt/pkg/domain/repository"
)
...
func (r *repositoryImpl) CreateUser(ctx context.Context, user *model.User) (*model.User, error) {
